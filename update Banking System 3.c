...
void locker_system() {
    ...
    printf("\n\n\t\t\tLOCKER SYSTEM\n");
    printf("\n\t\t1. Assign Locker\n");
    printf("\t\t2. View Locker\n");
    printf("\t\t3. Main Menu\n");
    printf("\n\t\tEnter your choice: ");
    scanf("%d", &locker_choice);

    switch (locker_choice) {
        case 1:
            // Implement code to assign a locker
            printf("\n\t\tLocker assigned successfully!\n");
            break;
        case 2:
            // Implement code to view assigned lockers
            printf("\n\t\tViewing lockers...\n");
            break;
        case 3:
...
void close(void)
{
    printf("\n\n\n\nThis Project is developed by sony ");
    }
